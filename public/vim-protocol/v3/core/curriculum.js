/* ============================================================
 * VIM Protocol 3 — curriculum (8 belt tracks)
...
(function () {
  ...
  function parseKeys(s) {
    var tokens = [];
    var i = 0;
    var SPECIAL = /^<(Esc|CR|BS|Tab|Left|Right|Up|Down|C-[a-z])>/;
    while (i < s.length) {
  ...
  var TRACKS = [
    /* ============ TRACK 1 — WHITE BELT ============ */
    {
      ...
      lesson: {
        intro:
          "Welcome to the Neon Dojo. I am BYTE, keeper of the first forms. " +
        ...
        techniques: [
          ...
          {
            keys: ":q!",
            desc: "get out NOW, discarding changes — the famous one",
          },
          { keys: "ZZ", desc: "save and quit without touching :" },
          { keys: "h j k l", desc: "left, down, up, right — the four winds" },
          {
            keys: "5j 12l",
            desc: "prefix any motion with a count to repeat it",
          },
      ...
      drills: [
        drill({
          id: "t1d0a",
          name: "The Door In, The Door Out",
          type: "match",
          brief: "Open notes.txt from the shell, then leave Vim with :q.",
          keys: "vim file  :q",
          shell: true,
          file: "notes.txt",
          requireExit: true,
        ...
        drill({
          ...
          type: "match",
          brief:
            "You were not supposed to touch this scroll. Make your mark anyway — then erase all evidence with :q!",
          keys: "i :q!",
          file: "ancient.txt",
          requireExit: true,
      ...
      duel: {
        ...
        rounds: [
          drill({
            ...
            name: "Footwork",
            type: "cursor",
            brief: "Checkpoints, counted strides.",
            keys: "counts + hjkl",
            start: [
    ...
    /* ============ TRACK 2 — YELLOW BELT ============ */
    {
      ...
      lesson: {
        intro:
          "I am BLADE. BYTE taught you to walk; I will teach you to dash. " +
        ...
        techniques: [
          ...
          {
            keys: ";  ,",
            desc: "repeat the last f/t strike — forward or back",
          },
      ...
      drills: [
        ...
        drill({
          ...
          type: "cursor",
          brief:
            "Vault whole paragraphs with { and }. Bounce across brackets with %.",
          keys: "{ } %",
          start: [
            "function setup() {",
            "  const arena = [1, 2];",
        ...
        drill({
          ...
          type: "cursor",
          brief:
            "Mix your word motions: ends with e, starts with w, back with b.",
          keys: "w e b counts",
      ...
      duel: {
        id: "t2duel",
        name: "SPARRING: BLADE DASH",
        opponent: "blade",
        intro:
          "Footwork bores me. Show me you can MOVE. Words, strikes, vaults — go.",
        winText: "Hm. Fast enough... for now. Take the Yellow Belt.",
        loseText:
          "Too slow. The cursor should arrive before the thought finishes.",
        rounds: [
          drill({
            id: "t2duel-r1",
            name: "Word Dash",
          ...
          drill({
            ...
            name: "Vault",
            type: "cursor",
            brief: "Brackets and breaks.",
            keys: "% f {",
            start: ["while (true) {", "  train();", "}", "", "spar();"],
            stops: [
              [0, 11],
              [0, 13],
              [2, 0],
    ...
    /* ============ TRACK 3 — ORANGE BELT ============ */
    {
      id: "t3",
      belt: "orange",
      title: "THE EDITING ARTS",
      subtitle: "Now your keystrokes leave marks.",
      instructor: "byte",
      lesson: {
        intro:
          "Movement was rehearsal. Today you change the buffer itself. " +
        ...
        techniques: [
          {
            keys: "x  X",
            desc: "delete the character under / before the cursor",
          },
          ...
          {
            keys: "Ctrl-[",
            desc: "escape without leaving home row — a master's habit",
          },
        ],
      },
      drills: [
        ...
        drill({
          ...
          type: "match",
          brief:
            "Step into insert mode with i (before) and a (after) — then step out.",
          keys: "i a <Esc>",
        ...
        drill({
          ...
          type: "match",
          brief:
            "O opens a line above, o opens below — build around the middle.",
          keys: "O o <Esc>",
          start: ["second line"],
      ...
      duel: {
        id: "t3duel",
        name: "SPARRING: FIRST CUTS",
        opponent: "byte",
        intro:
          "The buffer is a sparring partner now. Strike precisely — every keystroke is scored.",
        ...
        rounds: [
          ...
          drill({
            ...
            name: "Append Chain",
            type: "match",
            brief: "Semicolons at every line end.",
            keys: "A j",
    ...
    /* ============ TRACK 4 — GREEN BELT ============ */
    {
      ...
      lesson: {
        intro:
          "Here is the secret at the heart of vim: it is a LANGUAGE. " +
      ...
      drills: [
        ...
        drill({
          ...
          type: "match",
          brief:
            "c deletes and drops you into insert — one motion, one rewrite.",
          keys: "cw C",
        ...
        drill({
          ...
          type: "match",
          brief:
            "Counts multiply operators: d3w eats three words, 3dd eats three lines.",
          keys: "d3w 3dd",
          start: [
      ...
      duel: {
        id: "t4duel",
        name: "SPARRING: THE GRAMMAR",
        opponent: "byte",
        intro:
          "Speak the language. Verb, motion, done. I will count every syllable.",
    ...
    /* ============ TRACK 5 — BLUE BELT ============ */
    {
      ...
      lesson: {
        intro:
          "BYTE taught you verbs and motions. I teach you TARGETS. " +
      ...
      drills: [
        drill({
          ...
          type: "match",
          brief:
            "ciw rewrites the word under the cursor; daw removes word + space.",
          keys: "ciw daw",
        ...
        drill({
          ...
          type: "match",
          brief:
            'ci" and di" strike inside quotes — from anywhere on the line.',
          keys: 'ci" di"',
        ...
        drill({
          ...
          type: "match",
          brief:
            'da( and da" take the wrapper too. Sweep the leftover space with x.',
          keys: 'da( da" x',
        ...
        drill({
          ...
          type: "match",
          brief:
            "Nested parens: 2f( dives to the inner pair before the strike.",
          keys: "2f( ci(",
      ...
      duel: {
        ...
        rounds: [
          ...
          drill({
            id: "t5duel-r3",
            name: "Empty the Vessels",
            type: "match",
            brief: "Clear the parens, clear the braces.",
            keys: "di( di{",
    ...
    /* ============ TRACK 6 — PURPLE BELT ============ */
    {
      id: "t6",
      belt: "purple",
      title: "THE SEARCHING EYE",
      subtitle: "Why move when you can simply arrive?",
      instructor: "shell",
      lesson: {
        intro:
          "They call me SHELL. I watch everything on this grid, and now you will too. " +
        ...
        techniques: [
          ...
          {
            keys: "dt)  df)",
            desc: "delete until ) — excluding or including it",
          },
          {
            keys: "/find + edit",
            desc: "search, strike, repeat: the hunting loop",
          },
        ],
      },
      drills: [
        ...
        drill({
          ...
          type: "match",
          brief:
            "Hunt every BROKEN and rewrite it. /, ciw, n — the hunting loop.",
          keys: "/ n ciw",
          start: [
            'status = "BROKEN"',
        ...
        drill({
          ...
          type: "match",
          brief:
            "df] cuts through the bracket; dt stops just short of its mark.",
          keys: "df dt",
      ...
      duel: {
        id: "t6duel",
        name: "THE WATCHER'S TEST",
        opponent: "shell",
        intro:
          "I've watched every student who ever trained here. The fast ones never chase — they summon. Show me.",
        winText:
          "Heh. You found everything I hid. Purple Belt — you earned it.",
        ...
        rounds: [
          drill({
            ...
            name: "Signal Hunt",
            type: "cursor",
            brief: "Three signals. Find them all.",
            keys: "/ n",
            start: [
          ...
          drill({
            ...
            name: "Patch Job",
            type: "match",
            brief: "Hunt and rewrite both glitches.",
            keys: "/ n ciw",
    ...
    /* ============ TRACK 7 — BROWN BELT ============ */
    {
      ...
      lesson: {
        intro:
          "Sometimes you must SEE the blade's path before committing. " +
        ...
        techniques: [
          {
            keys: "v + motion",
            desc: "paint a selection character by character",
          },
          { keys: "V", desc: "paint whole lines" },
          {
            keys: "d  c  y  ~",
            desc: "strike the selection: cut, change, copy, flip case",
          },
      ...
      duel: {
        id: "t7duel",
        name: "BLADE'S GAUNTLET",
        opponent: "blade",
        intro: "Last lesson before the summit. Paint your cuts. Waste nothing.",
        winText:
          "Your selections land like shadows. Brown Belt. One climb remains.",
        loseText:
          "You painted too much — or too little. The blade must match the target.",
        rounds: [
          drill({
            id: "t7duel-r1",
            name: "Excision",
            type: "match",
            brief: "Cut the bracketed weight.",
            keys: "v f d",
    ...
    /* ============ TRACK 8 — BLACK BELT ============ */
    {
      id: "t8",
      belt: "black",
      title: "THE DOT AND THE WAY",
      subtitle: "Do it once. Let the dot do the rest.",
      instructor: "byte",
      lesson: {
        intro:
          "One key remains, and it is the deepest: the dot. " +
        ...
        techniques: [
          ...
          {
            keys: "/find  ciw  n .",
            desc: "the master loop: hunt, strike, repeat",
          },
          { keys: "qa … q", desc: "record your keystrokes into register a" },
          {
            keys: "@a  @@",
            desc: "replay the recording / repeat the last replay",
          },
        ],
      },
      drills: [
        ...
        drill({
          id: "t8d6",
          name: "The Recorded Form",
          type: "match",
          brief:
            "The dot repeats one change. A macro repeats a whole SEQUENCE: record with qa, stop with q, replay with @a and @@.",
          keys: "qa q @a @@",
        ...
        drill({
          ...
          type: "match",
          brief:
            "One recorded form, applied down the manifest. Start the recording with 0 so it lands the same on every line.",
          keys: "qa 0 d f D @a",
          start: [
            "order: ZZZ-001 [ship]",
            "order: ZZZ-002 [ship]",
      ...
      duel: {
        id: "t8duel",
        name: "CHAMPIONSHIP: BYTE UNBOUND",
        opponent: "byte-angry",
        intro:
          "No more teaching. No more mercy. I am the final wall, student. BREAK THROUGH.",
        winText: "MAGNIFICENT. You did not defeat me — you graduated past me.",
        loseText:
          "The wall stands. Catch your breath, then come back swinging.",
        rounds: [
          drill({
            id: "t8duel-r1",
            name: "Power Surge",
            type: "match",
            brief: "Three rewrites. One should be typed by hand.",
            keys: 'ci" j .',
          ...
          drill({
            ...
            name: "Counterform",
            type: "match",
            brief: "Inside the parens, then flip the warning.",
            keys: "ci( v ~",
          ...
          drill({
            ...
            name: "The Core",
            type: "match",
            brief: "Shields up, then strike the core.",
            keys: "ci( . v ~",
      ...
      finalDuel: {
        id: "t8final",
        name: "GRANDMASTER: BLADE ETERNAL",
        opponent: "blade",
        intro:
          "BYTE fell. I will not. Every form you learned came from my blade. Take the Black Belt — if you can.",
        winText:
          "It is done. The student stands where the masters stood. The Neon Dojo is yours.",
        ...
        rounds: [
          drill({
            ...
            name: "Shadow Step",
            type: "match",
            brief: "Strip the marks. The dot is faster than the hand.",
            keys: "2x j .",
            start: [
              "xxblade moves first",
              "xxyou counter fast",
          ...
          drill({
            ...
            name: "Blinding Speed",
            type: "match",
            brief: "Three strings. One rewrite, two stamps.",
            keys: 'ci" 0 .',
            start: [
              'speed("slow", 1);',
              'speed("slow", 2);',
          ...
          drill({
            ...
            name: "The Last Form",
            type: "match",
            brief: "Hunt, mend, bow. Everything ends here.",
            keys: "/ ciw . cw",
            start: [
              "the duel ends here",
  ...
  // Version 3: concise, actionable introductions; the original story lives in Archive.
  var intros = [
    "Start by opening and closing a file. Then learn h, j, k, and l to move without leaving the home row. Counts repeat a motion; 0, ^, $, gg, and G take you to useful boundaries. Arrow keys also work when you need them.",
    "Move in meaningful units. Use w and b for word beginnings and e for word endings. Find a character with f or t, repeat that find with ;, and use % to jump to a matching bracket.",
    "Normal mode is for commands; Insert mode is for writing. Choose where to enter with i, a, I, A, o, or O. Escape returns to Normal mode. Make a mistake, then use u to undo and Ctrl R to redo.",
    "Vim edits have a grammar: operator plus motion. Delete with d, change with c, or copy with y. Combine them with the motions you know. Double an operator to act on a whole line; p and P paste what you copied.",
    'Text objects describe what you want to change. ciw changes the word under the cursor; ci" changes the text inside quotes. Use i for inside and a for around, including the surrounding delimiters.',
    "Search forward with / or backward with ?. Type a literal word, press Enter, and use n or N to visit matches. Search wraps around the buffer. This training engine uses literal text, not regular expressions.",
    "Visual mode makes a selection before an edit. Use v for characters and V for lines, then a motion to extend the selection. Delete, change, or copy the selection, or adjust indentation with > and <.",
    "Repeat your last change with a single dot. For several steps, record a macro with qa, perform the commands, and stop with q. Replay with @a; @@ repeats the last macro. Combine search and repetition to make precise edits quickly.",
  ];
  TRACKS.forEach(function (track, index) {
    track.lesson.intro = intros[index];
  });
