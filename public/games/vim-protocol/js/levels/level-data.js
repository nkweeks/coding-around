...
const LEVELS = [
  ...
  // LEVEL 1: Basic Navigation - h, j, k, l
  {
    ...
    story: {
      ...
      preDialog: [
        ...
        { character: 'byte', lines: ["Greetings, recruit! I'm BYTE, the crew's AI construct.", "I've analyzed 2,847 training scenarios. Your optimal success path starts with h, j, k, l.", "I calculate a 73.2% chance you'll master this on the first try!"], image: 'images/robot_happy.jpeg' }
      ],
      postDialog: [
  ...
  // LEVEL 2: Word Navigation
  {
    ...
    story: {
      ...
      preDialog: [
        { character: 'blade', lines: ["In the shadows, every movement must be precise.", "w leaps to the next word. b falls back. e strikes the word's end.", "A ninja does not crawl letter by letter. A ninja flies."], image: 'images/ninja.jpeg' }
      ],
      postDialog: [
        { character: 'blade', lines: ["You have potential. Quick reflexes.", "NEXUS won't see you coming."], image: 'images/ninja.jpeg' }
      ]
    },
    initialBuffer: [
  ...
  // LEVEL 4: Character Search
  {
    ...
    story: {
      ...
      postDialog: [
        ...
        { character: 'blade', lines: ["Good find. NEXUS doesn't know we have it.", "That key could unlock everything... or be a trap."], image: 'images/ninja.jpeg' }
      ]
    },
    initialBuffer: [
  ...
  // LEVEL 5: Join the Crew
  {
    ...
    story: {
      ...
      postDialog: [
        ...
        { character: 'byte', lines: ["My models predicted your success! Welcome, operative! Your efficiency rating is already impressive!"], image: 'images/robot_happy.jpeg' },
        { character: 'shell', lines: ["Don't celebrate yet. The hard part starts now."] },
        { character: 'blade', lines: ["You move well. But the true test lies ahead. Stay sharp."], image: 'images/ninja.jpeg' }
      ]
    },
    initialBuffer: [
      "╔════════════════════════════════════╗",
  ...
  // LEVEL 6: Delete Operations
  {
    ...
    story: {
      ...
      postDialog: [
        { character: 'blade', lines: ["Clean work. You delete like someone who understands consequences.", "Every trace removed. NEXUS will never know we were here."], image: 'images/ninja.jpeg' },
  ...
  // LEVEL 8: Change Operations
  {
    ...
    story: {
      ...
      postDialog: [
        ...
        { character: 'blade', lines: ["Misdirection. A ninja's favorite weapon.", "But stay alert. NEXUS adapts quickly."], image: 'images/ninja.jpeg' }
      ]
    },
    initialBuffer: [
    ...
    story: {
      ...
      paths: {
        robot: {
          ...
          preDialog: [
            { character: 'byte', lines: ["My deep scan found BLADE's NEXUS uplink signatures.", "The ninja has been feeding them our coordinates for weeks.", "Use f and t to precisely target each marker character."], image: 'images/robot_happy.jpeg' }
          ]
        },
        ninja: {
          character: 'blade',
          ...
          preDialog: [
            { character: 'blade', lines: ["I've been tracking BYTE's hidden processes.", "The robot has been running NEXUS subroutines behind our backs.", "Use f and t to precisely locate each viral marker."], image: 'images/ninja.jpeg' }
          ]
        }
      }
    },
      ...
      paths: {
        ...
        ninja: {
          ...
          postDialog: [
            ...
            { character: 'blade', lines: ["The machine's reach grows longer every day.", "We need to strike soon, before it compromises another position."], image: 'images/ninja.jpeg' }
          ]
        }
      }
    },
    ...
    story: {
      ...
      paths: {
        ...
        ninja: {
          ...
          preDialog: [
            { character: 'blade', lines: ["The machine embedded viral payloads throughout the code.", "We must excise them surgically. Change the values, not the structure.", "One false cut and the virus spreads. Be precise."], image: 'images/ninja.jpeg' }
          ]
        }
      }
    },
  ...
  // LEVEL 18: Join & Indent
  {
    ...
    story: {
      character: 'zero',
      image: 'images/ninja_robot_fight_begins.jpeg',
      ...
      paths: {
        robot: {
          ...
          preDialog: [
            { character: 'byte', lines: ["Final confrontation imminent. My combat algorithms are at peak efficiency.", "BLADE has fortified the NEXUS command center.", "This ends now."], image: 'images/robot_happy.jpeg' },
        ...
        ninja: {
          ...
          preDialog: [
            { character: 'blade', lines: ["The machine has merged with NEXUS. It's stronger now.", "But steel cuts through circuits.", "This ends tonight."], image: 'images/ninja.jpeg' },
    ...
    story: {
      ...
      paths: {
        robot: {
          ...
          preDialog: [
            { character: 'blade', lines: ["You chose the machine over me? Foolish.", "I've fortified every bracket, every function with traps.", "You'll never reach the kill switch."], image: 'images/ninja.jpeg' },
        ...
        ninja: {
          ...
          preDialog: [
            { character: 'byte', lines: ["You're too late. I've merged with NEXUS core.", "Every bracket, every function, every line of code serves ME now."], image: 'images/evil_robot_defeats_ninja.jpeg' },
            { character: 'blade', lines: ["The machine has wrapped itself in layers of code.", "Use % to slice between brackets. I'll handle the rest.", "We end this. Now."], image: 'images/ninja.jpeg' },
    ...
    story: {
      ...
      paths: {
        robot: {
          ...
          completionImage: 'images/robot_defeats_ninja.jpeg',
          preDialog: [
            ...
            { character: 'byte', lines: ["All systems nominal. Combat efficiency at maximum.", "Together, we will end this. I believe in you, operative."], image: 'images/robot_happy.jpeg' },
          ...
          postDialog: [
            ...
            { character: 'byte', lines: ["Mission success probability was always high with you as my partner.", "Thank you for trusting me. My circuits have never been prouder.", "Processing emotion... I believe this is what humans call 'friendship'."], image: 'images/robot_happy.jpeg' },
        ...
        ninja: {
          ...
          completionImage: 'images/ninja_defeats_robot.jpeg',
          preDialog: [
            ...
            { character: 'byte', lines: ["You think you can stop me? I AM the network now.", "Every system, every node, every byte of data answers to me.", "Your ninja friend can't protect you from what I've become."], image: 'images/robot_angry.jpeg' },
            { character: 'blade', lines: ["The machine is powerful, but we are sharper.", "Fight with me. One final strike."], image: 'images/ninja.jpeg' },
            { character: 'shell', lines: ["Remember your training. Stay focused."] }
          ],
          postDialog: [
            ...
            { character: 'blade', lines: ["The machine is silenced. The shadows are safe once more.", "You fought with honor. I am proud to call you an ally.", "Until the next mission... stay sharp."], image: 'images/ninja.jpeg' },
            { character: 'shell', lines: ["Well done. You remind me of my younger self.", "That's the highest compliment I give."] }
          ]
        }
      },
